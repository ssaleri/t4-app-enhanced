  ...
  return (
    <YStack flex={1} space={"$4"}>
      <XStack justifyContent={"space-between"} space={"$2"}>
        <IconLabel icon={<Ionicons size={16} name={"person-circle"}/>} label={post.author} color={theme.color11.val} />
        <IconLabel icon={<Ionicons size={16} name={"calendar-outline"}/>} label={post.date} color={theme.color11.val} />
      </XStack>
      <H3 textAlign='left' fontWeight='700' color={theme.color12.val}>{post.title}</H3>
